...
Spin = 0.5
MC_save = 1000
MC_array = [10000, Int(MC_save), Int(MC_save/20.0)]
...
for L in [8, 16, 32, 64, 128]
    for j in 1:repeat_simulation
        ...
        run_data = string("DATA/L",L,"/Ising_S",Spin,"_J",J,"_H",H,"_MC",MC_array[1],"_Ti",T_array[1],"_Tf",T_array[3],"__",j)
